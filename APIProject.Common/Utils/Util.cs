        ...
        private static readonly string[] VietNamCharFile = new string[]
{
        ...
        public static long? ConvertPriceStringToLong(string price)
        {
            try
            {
                ...
                return (Int32)(millionPart * SystemParam.MILLION);
            }
            catch
            {
                return null;
        ...
        public static string ConvertPriceLongToString(long? price)
        {
            try
            {
                var millionPart = price / SystemParam.MILLION;
        ...
        public static int ConvertStatusStringToInt(string status)
        {
            try
            {
                if (status.Contains(SystemParam.VOUCHER_USED_NOT_STR))
                {
                    return SystemParam.VOUCHER_STATUS_NOT_USED;
                }
                else
                {
                    return SystemParam.VOUCHER_STATUS_USED;
                }
            }
            catch
            {
        ...
        public static string ConvertGenderType(int genderType)
        {
            try
            {
                switch (genderType)
                {
                    case SystemParam.Age_15_22:
                        return SystemParam.Age_15_22_STR;
                    case SystemParam.Age_23_35:
                        return SystemParam.Age_23_35_STR;
                    case SystemParam.Age_36_45:
                        return SystemParam.Age_36_45_STR;
                    case SystemParam.Age_Above_45:
                        return SystemParam.Age_Above_45_STR;
                    default:
                        return "";
                }
            }
